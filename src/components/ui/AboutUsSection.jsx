    ...
    <section className="w-full py-16 bg-gradient-to-br from-[#001F3F] via-[#002F5F] to-[#004080]">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            At Pinnacle Tools Center, we specialize in providing high-quality
            router bits, CNC bits, and power tools for professionals and DIY
            enthusiasts. With a commitment to precision, durability, and
            innovation, our products are designed to enhance efficiency and
            accuracy in every project. Whether you're a woodworker, metal
            fabricator, or industrial craftsman, our carefully curated selection
            ensures that you have the right tools to achieve flawless results.
          </motion.p>
        </div>
