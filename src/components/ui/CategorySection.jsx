...
const categories = [
  {
    name: "Power Tools",
    subcategories: [
      { name: "Angle Grinders", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313513/pinnacle-tools/staticassets/angle_grinders_kbzxpq.webp" },
      { name: "Drilling Machines", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313512/pinnacle-tools/staticassets/drilling_machines_gdfukc.jpg" },
      { name: "Hammer Ring Machines", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313513/pinnacle-tools/staticassets/hammering_machines_djayvq.jpg" },
      { name: "Demolition Hammers", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313513/pinnacle-tools/staticassets/demolition_hammer_machine_lojuj6.jpg" },
      { name: "Chain Saw Machines", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313512/pinnacle-tools/staticassets/chainsaw_machines_a11cj5.jpg" },
      { name: "Cutter Machines", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313514/pinnacle-tools/staticassets/cutter_machines_pqoptc.jpg" },
      { name: "Cordless Tools", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742037755/pinnacle-tools/staticassets/power-tools_ycbgc6.jpg" },
    ],
  },
  {
    name: "Hand Tools",
    subcategories: [
      ...
      { name: "Starbits", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313533/pinnacle-tools/staticassets/starbits_rxsx3v.jpg" },
    ],
  },
  {
    name: "Wood Working Tools",
    subcategories: [
      { name: "Router Bits", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742037393/pinnacle-tools/staticassets/router-bits_1_qhuxoe.jpg" },
      { name: "V Groove Blades", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313533/pinnacle-tools/staticassets/v-groove-blades_mxpusg.jpg" },
      { name: "CNC Bits", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313513/pinnacle-tools/staticassets/cnc-bits_aynjly.jpg" },
      { name: "Router Machines", image: "https://res.cloudinary.com/dduzbqxt7/image/upload/v1742313513/pinnacle-tools/staticassets/router_machines_uhi5vl.jpg" },
    ],
  },
  {
              ...
              {category.subcategories.map((sub, subIndex) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center text-center">
                    <Link href={`/products/${sub.name.toLowerCase().replace(/ /g, '-')}`}>
